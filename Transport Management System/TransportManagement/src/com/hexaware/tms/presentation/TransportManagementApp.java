 ...
 * Date: 19-Apr-2025
 * desc: UI for Transport Management System
 */

public class TransportManagementApp {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		ITransportManagementDao service = new TransportManagementDaoImpl();
		...
		while (true) {
			...
			try {
				...
				case 4:
					...
					System.out.println(
							service.scheduleTrip(vId, rId, dep, arr) ? "Trip scheduled." : "Failed to schedule trip.");
					break;
				...
				case 8:
					...
					System.out.println(
							service.allocateDriver(tripAllocId, driverId) ? "Driver allocated." : "Allocation failed.");
					break;
				...
				case 9:
					...
					System.out.println(
							service.deallocateDriver(deallocId) ? "Driver deallocated." : "Deallocation failed.");
					break;
